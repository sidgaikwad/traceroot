...
pip install -r examples/distributed_services/multi_code_agent/requirements.txt
```
...
Then you can modify the [`.traceroot-config.yaml`](https://github.com/sidgaikwad/traceroot-examples/blob/main/.traceroot-config.yaml) to setup the TraceRoot.AI.
